...
public class PlatformUsersFragment extends BaseFragment {
    @Bind(R.id.iv_back)
    ImageView ivBack;
    @Bind(R.id.tv_titles)
    TextView tvTitles;
    ...
    protected int getLayoutResource() {
        return R.layout.platform_users_fragment;
    }
    ...
    protected void onInitView(Bundle savedInstanceState) throws IOException {
        ...
        tvTitles.setText("设置");
        version.setText("当前版本: " + VersionUtil.getVersionName(mContext));
    }
    ...
    public void onclick(View view) {
        switch (view.getId()) {
            case R.id.exit:
                ...
                break;
            case R.id.updatepwd:
                JumpActivityUtil.launchActivity(mContext, UpdatePwdActivity.class);
                break;
            case R.id.detection:
                getPermission();
                break;
    ...
    private void versionUpdate(boolean isShowDownloadProgress) {
        ...
        String version = String.valueOf(VersionUtil.getVersionName(mContext));
...
//                .setAppKey("ab55ce55Ac4bcP408cPb8c1Aaeac179c5f6f")
    ...
    private void showDiyDialog(boolean isShowDownloadProgress, final UpdateAppBean updateApp, final UpdateAppManager updateAppManager) {
        ...
        DialogUtils.getInstance().showTimeDialog(
                mContext, R.layout.dialog_version,
    ...
    public void installAPK(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            apkuri = FileProvider.getUriForFile(mContext.getApplicationContext(), "com.syb.cobank.FileProvider", file);
        } else {
