...
public class AdministratorsAdapter extends RecycleAdapter<UserListEntity.DataBean> {
    public AdministratorsAdapter(Context context, int layoutId, List<UserListEntity.DataBean> datas) {
