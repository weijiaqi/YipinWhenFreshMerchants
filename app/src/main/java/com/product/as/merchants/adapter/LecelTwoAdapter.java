...
public class LecelTwoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private Context context;
    List<CateListEntity.DataBean> rowsBeans;
    private LecelTwoAdapter.OnMyItemClickListener myItemClickListener;

    public interface OnMyItemClickListener {
        void onItemClick(int id, String name, int positon);
    }

    public void setMyItemClickListener(LecelTwoAdapter.OnMyItemClickListener myItemClickListener) {
        this.myItemClickListener = myItemClickListener;
    }

    public LecelTwoAdapter(Context context, List<CateListEntity.DataBean> rowsBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LecelTwoAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((LecelTwoAdapter.ItemViewHolder) holder).bind();
    }
