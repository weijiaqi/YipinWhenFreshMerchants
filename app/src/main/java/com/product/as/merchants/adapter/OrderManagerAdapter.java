...
public class OrderManagerAdapter extends PagerAdapter {
    private List<BasePager> basePagers;

    private boolean isDestroyItem = true;

    public OrderManagerAdapter(List<BasePager> basePagers) {
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (isDestroyItem && basePagers.size() > 6) {
    ...
    public CharSequence getPageTitle(int position) {
        return UiUtils.getStringArray(R.array.order_tables)[position];
    }
}
