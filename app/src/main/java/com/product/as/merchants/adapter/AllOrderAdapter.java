...
public class AllOrderAdapter extends RecycleAdapter<OrderListsEntity.DataBean> {
    public AllOrderAdapter(Context context, int layoutId, List<OrderListsEntity.DataBean> datas) {
    ...
    @Override
    public void convert(RecyclerViewHolder holder, OrderListsEntity.DataBean dataBean) {
