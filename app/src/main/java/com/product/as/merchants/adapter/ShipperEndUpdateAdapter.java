...
public class ShipperEndUpdateAdapter extends RecyclerView.Adapter<ShipperEndUpdateAdapter.MyViewHolder>  {
    ...
    public ShipperEndUpdateAdapter(Context context, List<OrderListEntity.DataBean> list) {
        mContext = context;
        this.dataBeans = list;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //引入item布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_shapedend, parent, false);
        return new ShipperEndUpdateAdapter.MyViewHolder(view);
    }
