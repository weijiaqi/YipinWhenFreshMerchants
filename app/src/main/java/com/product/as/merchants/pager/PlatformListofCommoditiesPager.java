...
public class PlatformListofCommoditiesPager extends BasePager {
    ...
    public PlatformListofCommoditiesPager(Context context) {
        super(context);
    }
    ...
    public View initView(LayoutInflater layoutInflater) {
        ...
        delivery_products(dates.getText().toString() , String.valueOf(SharedPreferencesUtils.getSp(Constants.DELIID,"")));
