...
public class ShipperEndAdapter extends RecycleAdapter<OrderListEntity.DataBean> {
    public ShipperEndAdapter(Context context, int layoutId, List<OrderListEntity.DataBean> datas) {
