...
public class CourierMainAdapter extends PagerAdapter {
    private List<BasePager> basePagers;

    private boolean isDestroyItem = true;

    public CourierMainAdapter(List<BasePager> basePagers) {
    ...
    public CharSequence getPageTitle(int position) {
        return UiUtils.getStringArray(R.array.order_courier)[position];
    }
}
