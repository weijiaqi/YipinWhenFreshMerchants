...
public class CommodityCategoryTwoActivity extends BaseActivity {
    @Bind(R.id.rcylevel1)
        ...
        ApiInterfaceTwo.ApiFactory.createApi().catalist(id).enqueue(new Callback<CateListEntity>() {
            ...
            public void onResponse(Call<CateListEntity> call, Response<CateListEntity> response) {
                if (response.body().getFlag() == 1) {
                    ...
                    lecelOneAdapter = new LecelOneAdapter(CommodityCategoryTwoActivity.this, dataBeanList);
        ...
        ApiInterfaceTwo.ApiFactory.createApi().catalist(id).enqueue(new Callback<CateListEntity>() {
            ...
            public void onResponse(Call<CateListEntity> call, Response<CateListEntity> response) {
                if (response.body().getFlag() == 1) {
                    ...
                    lecelTwoAdapter = new LecelTwoAdapter(CommodityCategoryTwoActivity.this, dataBeanList2);
                            ...
                            public void onResponse(Call<CateListEntity> call, Response<CateListEntity> response) {
                                if (response.body().getFlag() == 1) {
                                    ...
                                    if (dataBeanList3 == null || dataBeanList3.size() == 0) {
                                        Intent intent = new Intent(CommodityCategoryTwoActivity.this, ProductDetailsActivity.class);
                                        ...
                                        lecelThreeAdapter = new LecelThreeAdapter(CommodityCategoryTwoActivity.this, R.layout.item_lievelone, dataBeanList3);
