...
public class CouriersMainAdapter extends PagerAdapter {
    private List<BasePager> basePagers;

    private boolean isDestroyItem = true;

    public CouriersMainAdapter(List<BasePager> basePagers) {
    ...
    public CharSequence getPageTitle(int position) {
        return UiUtils.getStringArray(R.array.order_couriers)[position];
    }
}
