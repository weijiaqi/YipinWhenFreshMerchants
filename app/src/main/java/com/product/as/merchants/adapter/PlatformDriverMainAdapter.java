...
public class PlatformDriverMainAdapter extends PagerAdapter {
    private List<BasePager> basePagers;

    private boolean isDestroyItem = true;

    public PlatformDriverMainAdapter(List<BasePager> basePagers) {
    ...
    public CharSequence getPageTitle(int position) {
        return UiUtils.getStringArray(R.array.order_platformcouriers)[position];
    }
}
